...
def _read_header():
    with open(os.path.join(os.path.dirname(__file__), 'cffi_gssapi.cdef'), 'r') as header:
        cdefs = header.read()

    autogenerated_file = os.path.join(os.path.dirname(__file__), 'autogenerated.cdef')
    if os.path.isfile(autogenerated_file):
        with open(autogenerated_file, 'r') as settings_file:
            generated_cdefs = settings_file.read()
        ...
        with open(autogenerated_file, 'w') as settings_file:
